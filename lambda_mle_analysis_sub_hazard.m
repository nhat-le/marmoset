...
save('mle_bootstraps_static_dynamic_sub_hazard_scaledc_filt06012020.mat', 'params_dynamic', 'flags_dynamic',...
...
if split(1) == 31
    rt_good = rt_filt(((sd_filt < 4) | (sd_filt > 4.04)) & ...
        ((xprev_filt < 4) | (xprev_filt > 4.04))); 
    sd_good = sd_filt(((sd_filt < 4) | (sd_filt > 4.04)) & ...
        ((xprev_filt < 4) | (xprev_filt > 4.04)));
    xprev_good = xprev_filt(((sd_filt < 4) | (sd_filt > 4.04)) & ...
        ((xprev_filt < 4) | (xprev_filt > 4.04)));
    
    rt_good2 = rt_good(((sd_good < 2.5) | (sd_good > 2.54)) & ...
        ((xprev_good < 2.5) | (xprev_good > 2.54)));
    sd_good2 = sd_good(((sd_good < 2.5) | (sd_good > 2.54)) & ...
        ((xprev_good < 2.5) | (xprev_good > 2.54)));
    xprev_good2 = xprev_good(((sd_good < 2.5) | (sd_good > 2.54)) & ...
        ((xprev_good < 2.5) | (xprev_good > 2.54)));
    
    data = [xprev_good2; rt_good2; sd_good2];
else
